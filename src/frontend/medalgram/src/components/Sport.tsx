...
export default function Sport({title, description}: componentsArgs) {
    ...
    return (
        <article className="col-span-1 border">
            ...
            <div className="bg-dark3 w-full flex flex-col justify-center text-xs items-center"><p className="text-black p-3">{description}</p>
                <div className="flex flex-wrap justify-center items-center px-8 py-0.5 rounded-3xl text-xs text-gray-300 text-xl bg-dark1"><Link href={`/sports/${sportId}/events`} className="nav-link link-body-emphasis active" aria-current="page">Ver carreras</Link>
