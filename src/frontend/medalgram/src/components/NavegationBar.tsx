            ...
            <div className="flex flex-nowrap items-center justify-between">
                ...
                <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
                    <div className="relative mt-3 md:hidden">
                        ...
                        <input type="text" id="search-navbar" className="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Buscar evento" />
                    </div>
                    <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium md:flex-row md:space-x-8 md:mt-0">
                        <li>
                            <div className="bg-dark0 rounded-lg p-1">
                                <Link href="/login" className="nav-link link-body-emphasis px-2 active text-white" aria-current="page">Iniciar Sesión</Link></div>
                        </li>
                        <li>
                            <div className="bg-white rounded-lg p-1">
                                <Link href="/signup" className="nav-link link-body-emphasis px-2 active text-dark0" aria-current="page">Crear Cuenta</Link></div>
                        </li>
                    </ul>
                </div>
            </div>
